...
<body>
	<div class="navbar">
		...
		<a class="active" href="Search.jsp"><i class="fa fa-fw fa-search"></i> Search</a>
	...
	<div class="row">
		<div class="search-container">
		    ...
		    <button onclick="link()"><i class="fa fa-search"></i></button>
	  	</div>
	</div>
	<div class="booklist">
		<%
			String searchString = request.getParameter("id");
			if(searchString != null)
			{
				NumberFormat formatter = new DecimalFormat("0.00");
				ArrayList<Book> books = BookDAO.bookSearch(searchString);
...
<script>
	function link()
	{
		...
		location.href = "Search.jsp?id="+id;
	}
</script>
</html>